...
BLIND_LOOKAHEAD  = 12     # max WRITE events scanned after a Region-B precursor
BLIND_MIN_RUN    = 2      # min contiguous 4K pages to register a candidate run
BLIND_GAP_TOL    = 2      # max skipped pages within a run
BLIND_WINDOW_US  = 40     # max elapsed time from precursor to run start
