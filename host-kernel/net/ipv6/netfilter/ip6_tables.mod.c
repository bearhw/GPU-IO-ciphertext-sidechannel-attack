...
SYMBOL_CRC(ip6t_alloc_initial_table, 0x016d8a0e, "_gpl");
SYMBOL_CRC(ip6t_register_table, 0xc3f30d21, "");
SYMBOL_CRC(ip6t_unregister_table_pre_exit, 0x971bef64, "");
SYMBOL_CRC(ip6t_unregister_table_exit, 0x949ea9cc, "");
SYMBOL_CRC(ip6t_do_table, 0xae85d15b, "");
