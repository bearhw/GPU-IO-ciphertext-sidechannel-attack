...
SYMBOL_CRC(esp_output_head, 0x0ac5845b, "_gpl");
SYMBOL_CRC(esp_output_tail, 0x2d0558c9, "_gpl");
SYMBOL_CRC(esp_input_done2, 0xc6e82f17, "_gpl");
...
MODULE_INFO(srcversion, "98F7F0EE35148ED0AD2386D");
