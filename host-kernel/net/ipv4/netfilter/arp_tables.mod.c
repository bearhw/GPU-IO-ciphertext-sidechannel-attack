...
SYMBOL_CRC(arpt_alloc_initial_table, 0x91ec39a8, "_gpl");
SYMBOL_CRC(arpt_unregister_table_pre_exit, 0x51b2d6fa, "");
SYMBOL_CRC(arpt_register_table, 0xca74480c, "");
SYMBOL_CRC(arpt_unregister_table, 0x272e9f57, "");
SYMBOL_CRC(arpt_do_table, 0x3f116e4f, "");
