...
SYMBOL_CRC(ax25_register_pid, 0x4e69cc4a, "_gpl");
SYMBOL_CRC(ax25_protocol_release, 0x8ede9e26, "");
SYMBOL_CRC(ax25_linkfail_register, 0x8baa23e9, "");
SYMBOL_CRC(ax25_linkfail_release, 0x08ac5eea, "");
SYMBOL_CRC(ax25_listen_register, 0x81ca2730, "");
SYMBOL_CRC(ax25_listen_release, 0x4563ebe9, "");
SYMBOL_CRC(ax25_header_ops, 0x1aa6fae8, "");
SYMBOL_CRC(ax25_ip_xmit, 0xd0bea319, "");
SYMBOL_CRC(ax25_send_frame, 0xf67d38c2, "");
SYMBOL_CRC(ax25_display_timer, 0x14cecd59, "");
SYMBOL_CRC(ax25_uid_policy, 0x242852b9, "");
SYMBOL_CRC(ax25_findbyuid, 0xee02e420, "");
SYMBOL_CRC(ax25_find_cb, 0x88c9652c, "");
...
__used __section("__versions") = {
	...
	{ 0x7ae4e228, "__skb_try_recv_datagram" },
	...
	{ 0xfe80d4d7, "__skb_wait_for_more_packets" },
...
MODULE_INFO(srcversion, "748989A32418A1C574B2DBA");
