...
SYMBOL_CRC(rapl_remove_package, 0xd5736ff4, "_gpl");
SYMBOL_CRC(rapl_find_package_domain, 0x883c3157, "_gpl");
SYMBOL_CRC(rapl_add_package, 0xbc147db8, "_gpl");
...
__used __section("__versions") = {
	...
	{ 0x6d606913, "pv_ops" },
	{ 0x3dcd4e81, "powercap_unregister_zone" },
	...
	{ 0x982a0b30, "powercap_register_zone" },
...
MODULE_INFO(srcversion, "720CFEA9A0DE39A7808880B");
