...
__used __section("__versions") = {
	...
	{ 0xf1c3a19e, "devm_regmap_add_irq_chip" },
...
MODULE_ALIAS("i2c:sm5504");
MODULE_ALIAS("i2c:sm5703-muic");
MODULE_ALIAS("of:N*T*Csiliconmitus,sm5502-muic");
MODULE_ALIAS("of:N*T*Csiliconmitus,sm5502-muicC*");
MODULE_ALIAS("of:N*T*Csiliconmitus,sm5504-muic");
MODULE_ALIAS("of:N*T*Csiliconmitus,sm5504-muicC*");
MODULE_ALIAS("of:N*T*Csiliconmitus,sm5703-muic");
MODULE_ALIAS("of:N*T*Csiliconmitus,sm5703-muicC*");

MODULE_INFO(srcversion, "C956674676D4C40569CC405");
