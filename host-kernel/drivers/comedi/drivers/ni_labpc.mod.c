...
__used __section("__versions") = {
	...
	{ 0x1766e6d5, "labpc_free_dma_chan" },
	...
	{ 0x5a56f828, "labpc_init_dma_chan" },
	{ 0x73c52860, "comedi_driver_register" },
	{ 0x790c1b0c, "comedi_driver_unregister" },
	{ 0x817bf968, "module_layout" },
};

MODULE_INFO(depends, "ni_labpc_isadma,ni_labpc_common,comedi");


MODULE_INFO(srcversion, "B3BD719E57266E86394785D");
